        ...
        {activeTab === 'shop' && (
          <div>
            <div className="bg-[#0e2913] text-white py-12 px-4 text-center">
              <div className="inline-flex items-center space-x-2 px-3.5 py-1 rounded-full border border-emerald-700 bg-emerald-950/60 text-amber-300 text-xs font-bold mb-3">
                <Sprout className="w-4 h-4" />
                <span>Certified Organic Store</span>
              </div>
              <h1 className="text-4xl font-black mb-2">Plant Care & Organic Products Marketplace</h1>
              <p className="text-slate-300 text-sm max-w-xl mx-auto">
                Buy 100% organic bio-fertilizers, neem oil pest controls, seaweed growth boosters, vermicompost, and fresh farm produce.
              </p>
            </div>
            <ShopSection
