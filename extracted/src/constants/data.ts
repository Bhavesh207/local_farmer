...
export const IMAGES = {
  ...
  farmerVideoThumb: 'https://images.unsplash.com/photo-1592417817098-8f3d6eb1642f?auto=format&fit=crop&w=400&q=80',
...
export const SERVICES_DATA: ServiceItem[] = [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1592417817098-8f3d6eb1642f?auto=format&fit=crop&w=800&q=80',
    fullDetails: {
...
export const PRODUCTS_DATA: ProductItem[] = [
  ...
  {
    id: 'p3',
    name: 'Bio-Active Organic Soil Compost',
    category: 'soil',
    price: 18.00,
    unit: '20 lb Bag',
    rating: 4.8,
