...
export const ServiceDetailModal: React.FC<ServiceDetailModalProps> = ({
  ...
  // Sample Mandi Data
  const mandiRates = [
    { crop: 'Wheat (Gehun)', mandi: 'Karnal Central Mandi', min: 2275, max: 2450, modal: 2380, trend: '+2.4%' },
    { crop: 'Paddy Rice (Basmati 1121)', mandi: 'Punjab Grain Market', min: 3800, max: 4250, modal: 4100, trend: '+1.8%' },
    { crop: 'Hybrid Tomato', mandi: 'Nashik Wholesale Yard', min: 1400, max: 2100, modal: 1850, trend: '-3.2%' },
    { crop: 'Desi Cotton (Kapas)', mandi: 'Rajkot Cotton Yard', min: 6800, max: 7450, modal: 7200, trend: '+4.1%' },
    { crop: 'Mustard (Sarson)', mandi: 'Jaipur Agriculture Hub', min: 5100, max: 5650, modal: 5400, trend: '+0.9%' },
    { crop: 'Red Onion (Pyaz)', mandi: 'Lasalgaon Mandi', min: 1200, max: 1800, modal: 1550, trend: '-1.5%' },
              ...
              <div className="flex flex-col sm:flex-row items-center gap-3">
                <div className="relative flex-1 w-full">
                  ...
                  <input
                    ...
                    placeholder="Search crop or mandi (e.g. Wheat, Karnal, Cotton)..."
        ...
        return (
          <div className="space-y-4">
            ...
            <div className="p-4 bg-emerald-950/90 rounded-2xl border border-amber-400/50 flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              >
                <img
                  src="https://images.unsplash.com/photo-1592417817098-8f3d6eb1642f?auto=format&fit=crop&w=400&q=80"
